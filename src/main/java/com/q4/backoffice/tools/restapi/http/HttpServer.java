package com.q4.backoffice.tools.restapi.http;
...
import com.q4.backoffice.tools.restapi.actor.RequestSupervisor;
...
import com.q4.backoffice.tools.restapi.metrics.MetricsGenerator;
import com.q4.backoffice.tools.restapi.utilities.ResourceFile;
...
import static akka.http.javadsl.model.ContentTypes.TEXT_PLAIN_UTF8;
	...
	private Route getQueryRoute(String userid, HttpRequest request, String remainingUrl) {
		...
		if (userid.isEmpty()) {
			...
			try {
				...
				String url = URLDecoder.decode(remainingUrl, "UTF-8");

				//check for format in name
				String contentTypeName = stringRight(url,".");
				String name = stringLeft(url,".");
